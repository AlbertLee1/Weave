...
func (m *mockRepo) UpdateBranchBaseVersion(_ context.Context, _ string, _ int64) error {
	return nil
}
...
func (m *mockRepo) UpdateBranchChangeBeforeState(_ context.Context, _ string, _ json.RawMessage) error {
	return nil
}
