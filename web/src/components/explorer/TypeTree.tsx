...
export function TypeTree({ objectTypes, selectedType, onSelect }: TypeTreeProps) {
  return (
    <nav className="flex flex-col gap-0.5 py-2" data-testid="type-tree">
      ...
      {objectTypes.map((ot) => {
        ...
        return (
          <button
            ...
            className={`flex items-center justify-between gap-2 px-3 py-1.5 text-left text-sm rounded mx-1 transition-colors ${
              isSelected
