...
function DrawerShell({ testId, title, onClose, children }: DrawerShellProps) {
  ...
  // focus to whatever element opened the drawer (typically the New rule / Edit
  // / View runs trigger) when it unmounts — so keyboard users never end up
  // behind the overlay. Mirrors SagaJobsPage's DrawerShell (#244) /
  // VertexShareLinkPanel (#229).
