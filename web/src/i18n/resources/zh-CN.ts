...
const zhCN = {
  ...
  branch: {
    ...
    createNew: '新建分支…',
    createTitle: '创建分支',
    createNamePlaceholder: '分支名称',
    createSubmit: '创建',
    creating: '正在创建…',
    createError: '创建分支失败：{{message}}',
    cancel: '取消',
    deleteLabel: '关闭分支',
  ...
  branchReconcile: {
    ...
    rebaseButton: '变基到 main',
    rebasing: '正在变基…',
    rebaseConfirm: '将该分支变基到最新的 main？待合并的变更会基于当前 main 状态重新计算。',
    rebaseSuccess: '已将分支变基到 main（基线版本 {{version}}）。',
    rebaseConflictHint: '变基与 main 存在 {{count}} 个冲突——请在合并时解决。',
    rebaseError: '变基失败：{{message}}',
